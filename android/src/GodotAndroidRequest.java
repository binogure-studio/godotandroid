...
public class GodotAndroidRequest {
	public static final int GODOT_SHARE_REQUEST = 7001;
	...
	public static final int FIREBASE_INVITE_REQUEST = 8001;
	public static final int FIREBASE_NOTIFICATION_REQUEST = 8002;
}